...
>   (`breadboard-fence-v0.4.0` and later)
> - **Code and grammar**: [packages/breadboard-fence](https://github.com/tommie-jp/tommie-fence/tree/main/packages/breadboard-fence)
> - **History**: every commit came along
>   (`git log packages/breadboard-fence` reaches back to the first one)
>
> The releases kept here end at `v0.3.0`. **The four improvements made after
> `v0.3.0` are in `breadboard-fence-v0.4.0`.**
